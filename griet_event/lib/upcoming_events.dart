...
// class _EventPageState extends State<EventsUpcoming> {
...
//         backgroundColor: const Color.fromARGB(190, 130, 41, 1),
//       ),
//       body: Column(
...
//                               ? FontWeight.bold
//                               : FontWeight.normal,
//                           color: isUpcomingSelected ? Colors.green : null,
//                         ),
//                       ),
//                     ),
//                     GestureDetector(
...
//                           context,
//                           MaterialPageRoute(builder: (context) => EventsPast()),
//                         );
//                         setState(() {
...
//                             children: [
//                               Image.network(
//                                 'https://www.festivalsherpa.com/wp-content/uploads/2017/12/Festival-Crowd-e1472160900369.jpg',
//                                 height: 150,
            ...
            child: FutureBuilder<List<EventModel>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  final upcomingEvents = filterUpcomingEvents(snapshot.data!);
                  return Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: ListView.builder(
